...
This is mostly based on the official [python tutorial](https://docs.python.org/2/tutorial/) (also have a look at [version 3 tutorial](https://docs.python.org/3/tutorial/index.html) to see how things will change in the future): reading the tutorial is highly recommended to make sure your python is up to speed.
