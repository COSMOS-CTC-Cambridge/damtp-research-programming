...
``` {.python}
  ...
  try:
      ...
      if (te.message.endswith("is not iterable")):
          lista = [x for x in res1.result()]
  finally:
...
### Distributed Computing example has a design flaw, fix it
