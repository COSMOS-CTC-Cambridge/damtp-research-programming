ORGFILES=course.org plans.org slides.org todo.org modules/algorithms.org modules/io_viz.org modules/optimisation.org modules/practices.org modules/prototyping.org modules/python.org modules/requirements_for_environment.org modules/shell.org modules/mpi.org modules/unfinished.org modules/debugging.org
MDFILES=modules/algorithms.md modules/io_viz.md modules/optimisation.md modules/practices.md modules/prototyping.md modules/python.md modules/requirements_for_environment.md modules/shell.md modules/mpi.md modules/unfinished.md modules/debugging.md 
SRCFILES=codes/python/distributed_computing_interactive.py codes/python/ipyparallel_and_mathematica.py codes/python/mixed_mode_mapreduce.py codes/python/mpi_hello_world.py codes/python/profile_example.py codes/python/debugging_pdb.py codes/python/debugging_simple.py codes/python/debugging_threads.py codes/cpp/c_segfaults1.c codes/cpp/c_segfaults2.c codes/cpp/subdir0/input.dat codes/cpp/subdir1/input.dat
PDFFIELS=course.pdf
